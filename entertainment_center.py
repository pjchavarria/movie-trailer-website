...
arslan_senki = media.Anime("Arslan Senki",
...
fate_stay = media.Anime("Fate/stay night: ULW",
...
grisaia_no_rakuen = media.Anime("Grisaia no Rakuen",
...
sidonia_2 = media.Anime("Sidonia no Kishi: Daikyuu Wakusei Seneki",
...
movies = [arslan_senki, fate_stay, grisaia_no_rakuen, nisekoi_2, yamada_kun, sidonia_2]       
